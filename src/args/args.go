...
type ArgumentList struct {
	...
	ConsumerGroups     string `default:"{}" help:"DEPRECATED -- JSON Object allowed list of consumer groups to their topics and topics to their partitions, in which to collect consumer offsets for."`
