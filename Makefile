...
integration-test:
	...
	@go test -v -tags=integration ./tests/integration/. -count=1;docker logs kafka_dummy_producer; docker logs kafka_dummy_consumer;docker logs kafka_dummy_consumer2  ; (ret=$$?; docker-compose -f tests/integration/docker-compose.yml down && exit $$ret)
