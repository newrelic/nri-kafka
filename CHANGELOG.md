...
### enhancement
- Collect the Kafka broker-reported cluster ID (`kafkaClusterId`) as a metric attribute on broker, topic, consumer, producer, and consumer-offset samples
...
- Updated golang.org/x/sync to v0.23.0

## v3.24.0 - 2026-09-01

### 🛡️ Security notices
- update golang.org/x/crypto to v0.55.0
- golang.org/x/net to v0.57.0
- golang.org/x/text to v0.41.0
...
- Updated github.com/newrelic/nrjmx/gojmx digest to ec73e85
...
- update golang.org/x/crypto to 0.52.0
