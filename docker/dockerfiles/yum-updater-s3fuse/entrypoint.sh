...
# Update metadata in Repo path
echo "==> Updating YUM repo metadata in PATH: $REPO_YUM_UPDATE_METADATA_PATH"
LOCAL_REPO_PATH="${AWS_S3_MOUNTPOINT}${REPO_YUM_UPDATE_METADATA_PATH}"
